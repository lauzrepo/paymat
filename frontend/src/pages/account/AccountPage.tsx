...
function Field({ label, value }: { label: string; value: string | null | undefined }) {
  return (
    <div>
      ...
      <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{value ?? <span className="text-gray-400 dark:text-gray-500 italic">Not set</span>}</dd>
    </div>
  );
}
      ...
      {contact && (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Contact Info</h2>
          </div>
          <dl className="px-5 py-4 grid grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <dt className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Date of Birth</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{dob ?? <span className="text-gray-400 dark:text-gray-500 italic">Not set</span>}</dd>
              </div>
            </div>
          </dl>
        </div>
      ...
      {contact?.family && (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Family</h2>
          </div>
          <dl className="px-5 py-4 grid grid-cols-2 gap-4">
