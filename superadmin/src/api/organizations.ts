...
export const setClassBookingEnabled = (id: string, enabled: boolean): Promise<Organization> =>
  apiClient.patch(`/organizations/${id}/class-booking`, { enabled }).then((r) => r.data.data.organization);
