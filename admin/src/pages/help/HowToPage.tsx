    ...
    items: [
      {
        ...
        steps: [
          ...
          'Each row shows the invoice number, amount, payment method, status, and date.',
          'Use the status filter at the top to narrow results by Succeeded, Failed, or Refunded.',
        ],
      },
      {
        ...
        steps: [
          ...
          'Find the payment you want to refund — only card payments processed through Stripe can be refunded here.',
          'Click the Refund link on that row.',
          'Confirm the full refund amount shown and click Confirm.',
          'The charge is refunded in Stripe immediately, and the related invoice\'s paid amount is automatically reduced.',
          'If the invoice is no longer fully paid it reverts to Sent or Overdue status.',
        ],
      },
    ],
  },
